<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="TitleInsertValidationMessages.aspx.cs" Inherits="_Default" %>
                ...
                <asp:TemplateField HeaderText="Price">
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="price" ErrorMessage="Price is required"></asp:RequiredFieldValidator>
                        <br />
                ...
                <asp:TemplateField HeaderText="PubDate">
                    <EditItemTemplate>
                        ...
                        <asp:RangeValidator ID="RangeValidator2" runat="server" 
                            ...
                            MaximumValue="12/31/2100" MinimumValue="1/1/1900" Type="Date"></asp:RangeValidator>
                     </EditItemTemplate>                
                </asp:TemplateField>
